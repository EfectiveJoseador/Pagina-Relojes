        ...
        <footer class="main-footer">
            <div class="container footer-grid">
                <div class="footer-col">
                    <h4>Luxe MOD Watches</h4>
                    <p class="text-muted">Tu destino exclusivo para relojes de lujo. Elegancia, precisión y estilo en cada pieza.</p>
                </div>
                <div class="footer-col">
                ...
                <div class="footer-col">
                    <h4>Contacto</h4>
                    <ul class="footer-links">
                        <li><a href="mailto:luxemodwatches@gmail.com"><i class="fas fa-envelope"></i> luxemodwatches@gmail.com</a></li>
                    </ul>
            ...
            <div class="footer-bottom">
                <p>&copy; 2025 Luxe MOD Watches. Todos los derechos reservados.</p>
            </div>
        </footer>
    `,
    ...
    styles: `
        <style id="cookie-consent-styles">
            .cookie-consent {
                ...
                border-top: 1px solid var(--border, rgba(212, 175, 55, 0.2));
                padding: 1rem 1.5rem;
                z-index: 9999;
